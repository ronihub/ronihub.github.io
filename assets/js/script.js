$(document).ready(function () {
  ...
  $(".hamburger-menu").on("click", function (e) {
    if ($("body").hasClass("hamburger-navigation-active")) {
      ...
      $("body .hamburger-navigation .nav-menu").css("transition-delay", "0.0s");
...
window.onscroll = function () {
  ...
  if (num >= 160) {
    document.querySelector("#nav_nav").classList.add("dark-bg");
    document.querySelector("#scrollTop").classList.add("active");
  } else {
    document.querySelector("#nav_nav").classList.remove("dark-bg");
